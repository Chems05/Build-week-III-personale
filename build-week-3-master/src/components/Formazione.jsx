        ...
        <Col>
          <div className="d-flex justify-content-start align-items-start mt-3">
            ...
            <div>
              ...
              <p>
                Front-end Development Bootcamp focused on: - HTML - CSS -
                JavaScript - Bootstrap - SASS - React.js
              </p>
              <p>
                Competenze: E-learning · Team building · Flexible Approach ·
                SASS · Bootstrap · JavaScript · CSS · HTML
              </p>
            </div>
          </div>
        </Col>
