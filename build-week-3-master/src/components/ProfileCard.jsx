    ...
    <>
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text className="text-center fw-light text-decoration-none">
            {profile?.title}
          </Card.Text>
        </Card.Body>
        ...
        <ListGroupItem className="list-group-flush px-3 pb-1">
          <ListGroup.Item className="pt-3 pb-1">
            <Link className="d-flex justify-content-between align-items-center text-decoration-none">
              <p className="numbers mb-0 text-secondary fw-bold">
          ...
          <ListGroup.Item className="pt-3 pb-1">
            <Link className="d-flex justify-content-between align-items-center text-decoration-none">
              <p className="numbers mb-0 pb-2 text-dark fw-bold">
                <BsBookmarkFill className="me-2 text-secondary" />I miei
                elementi
              </p>
            </Link>
          </ListGroup.Item>
          ...
          <ListGroup className="list-group-flush">
            ...
            <ListGroup.Item className="pt-3 pb-1">
              <Link className="discover text-decoration-none">
                <p className=" mb-0 pb-2 text-secondary fw-bold fs-6">
                  Scopri di più
                </p>
              </Link>
            </ListGroup.Item>
