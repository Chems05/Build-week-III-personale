...
const CentralCardHome = ({ post, setModificaPost, setSelectPost }) => {
  ...
  const getCommentFetch = async () => {
    ...
    const headers = {
      headers: {
        ...
        Authorization:
          "Bearer " +
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2Njk5MWNjODg3ZmZjYjAwMTU3NGNiN2EiLCJpYXQiOjE3MjEzMTA0MDgsImV4cCI6MTcyMjUyMDAwOH0.rqvx0RdnErmfOGtOMVp3ckczUKXtGBuZyYEsa8Qdi90",
      },
    };
    try {
  ...
  return (
    <>
      <Container
        fluid
        className="bg-white border border-1 rounded pt-3 pb-1 mt-3 mb-4"
      >
        <div className="px-2 d-flex justify-content-between align-items-center">
          <div>
            ...
            <small className="ms-2 numbers">
              Consigliato da <strong>Chems Zghaidi</strong>
            </small>
          </div>
        ...
        <div className="d-flex justify-content-between align-items-start">
          ...
          {profile?._id === post?.user?._id && (
            <Dropdown>
              <Dropdown.Toggle
                className="dropdown-custom border-0 threeDots"
                id="dropdown-basic"
              >
        ...
        <div className="d-flex justify-content-between align-items-center pt-3 pe-3 mb-0">
          <div className="d-flex align-items-center px-3 mt-3">
            ...
            <p className="numbers fw-normal text-secondary mb-0">
              Francesco Cacciapuoti e altri
            </p>
          </div>
          <p className="numbers fw-normal text-secondary mb-0 mt-3">
            5 Commenti &#183; 10 diffusioni post
          </p>
        </div>
        <hr />
        <div className="d-flex justify-content-between mt-3 mb-4">
          ...
          <div id="iconCentralCardHome">
            ...
            >
              ...
              <span className="text-secondary fw-semibold ms-2">
                Diffondi il post
              </span>
            </Button>
          </div>
          <div id="iconCentralCardHome">
            <Button
              id="iconCentralCardHome"
              variant="light"
              className="mb-0 ms-2 mx-1 d-flex"
            >
