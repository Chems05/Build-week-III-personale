    ...
    <>
      ...
      >
        <Button id="BadgeJobs" className="fs-6">
          <span className="fw-semibold">Vedi altro</span>{" "}
          <FaChevronDown className="ms-1 fs-5" />
        </Button>
      </Link>
          ...
          <ListGroup.Item>
            <Link className="text-decoration-none text-dark">
              <p className="m-0 fw-semibold">
                junior developer ·
                <small className="text-success fw-semibold"> 56 nuove</small>
              </p>
              <small className="text-secondary fw-semibold">
                Avviso attivo · luogo, esperienza minima
              </small>
            </Link>
          </ListGroup.Item>
          <ListGroup.Item>
      ...
      >
        <Button id="BadgeJobs" className="fs-6 ">
          <span className="fw-semibold">Meno dettagli</span>{" "}
          <FaChevronUp className="ms-1 fs-5" />
        </Button>
      </Link>
    </>
  );
