  ...
  return (
    <>
      <Link
        ...
        className={`buttonCollapse text-secondary fs-6 fw-bold px-4 mb-0 ${
          open && "d-none"
        }`}
          ...
          <ul className="list-group-flush">
            <li className="pt-3 pb-1">
              <Link className="text-decoration-none">
                ...
                <small className="numbers text-secondary ">
                  Notizie principali &#183; 142 lettori{" "}
                </small>
              </Link>
            </li>
            <li className="pt-3 pb-1">
            ...
            <li className="pt-3 pb-1">
              <Link className="text-decoration-none">
                <p className="numbers text-dark fw-bold mb-0 text-truncate">
                  Scaldare le case con la grappa
                </p>
                <small className="numbers text-secondary ">
                  1 ora fa &#183; 639 lettori{" "}
                </small>
              </Link>
            </li>
            <li className="pt-3 pb-1">
