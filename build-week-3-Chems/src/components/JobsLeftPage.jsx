    ...
    <div className="my-sticky">
      <Card className="p-4">
        <div className="d-flex align-items-center mt-2">
          ...
          <p className="fw-semibold fs-normal mx-2 mb-1">
        ...
        <div className="d-flex align-items-center mt-4">
          ...
          <p className="fw-semibold fs-normal mx-2 mb-1">
            Indicazioni per la ricerca di lavoro
          </p>
        </div>
        <div className="d-flex align-items-center mt-4">
      ...
      <Button
        id="ButtonPubblicaJobs"
        className="mt-3 d-flex jutify-content-center align-items-center"
      >
        <div className="d-flex justify-content-center align-items-center">
          <BsPencilSquare className="fs-4 ms-4" />
          <small className="ms-3 small flex-fill fw-bold">
